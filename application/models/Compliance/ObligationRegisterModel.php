...
class obligationRegisterModel extends CI_Model {
    ...
    function __construct() {
        parent::__construct();
        $this->table = "obligation_register";
    ...
    function getAll() {
        ...
        foreach ($results as $key => $value) {
            $results[$key]['obligations'] = $results[$key]['obligations'] = $this->obligation->getAuthority($value['id']);
        }
        return $results;
    }
    ...
    function getObligation($obligation_id) {
        return [];
        //return $this->obligationRelationship->getObligation($obligation_id,"obligationRegister");
    }
