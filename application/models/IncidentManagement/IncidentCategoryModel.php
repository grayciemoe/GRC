...
class incidentCategoryModel extends CI_Model {
    ...
    function getControl($incident_id) {
        return [];
    }
    ...
    function getALl() {
        ...
        foreach ($array as $key => $value) {
            $array[$key]['incidents'] = $this->getCategoryIncidents($value['id']);
        }
        return $array;
    }

    function getCategoryIncidents($category_id) {
        return $this->incident->getCategory($category_id);
    }
