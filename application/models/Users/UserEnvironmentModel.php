...
class userEnvironmentModel extends CI_Model {
    ...
    function getUserEnvironmemts($user_id) {
    ...
    function setUserEnvironments($user, $environments) {
        $this->db->where("user", $user);
        $this->db->delete($this->table);
        foreach ($environments as $key => $value) {
            $this->add(array("user" => $user, "environment" => $value));
        }
    }
