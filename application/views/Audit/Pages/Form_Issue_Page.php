        ...
        <div class="row">
            ...
            <div class="col-sm-5">
                ...
                <div class='form-group '>
                    ...
                    <input type="text" class="hidden" name="risk" id="actual_risk_id" value="<?= $issue['risk_associated'] ?>" />
                    ...
                    <div class='col-sm-12' id="cover-risk-dropdown">
                        <select class="form-control select2"  required id="txt-im-risk"  name="risk_associated" onchange="document.getElementById('actual_risk_id').value = this.value" >
