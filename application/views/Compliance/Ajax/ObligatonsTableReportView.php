<div class="card"> 
    ...
    <div id="table_compliance_report" class="card-block table-responsive">
        ...
        <table id="datatable"  class="table table-sm table-small table-striped" cellspacing="0" width="100%">
            <thead>
                <tr>
                    <th>REF Code</th>
                    <th>Title</th>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group pull-right">
                                <?php if ($value['last_submission_status'] == 'late_review') : ?>
                                ...
                                <?php if ((time() + (3600 * 24 * 7) ) > strtotime($value['submission_deadline']) and $value['last_submission_status'] == 'complied'): ?>
                                    <?php if (am_user_type(array(1, 5, 7))): ?>    
                                        <a href="<?= base_url("index.php/Compliance/obligationAction/{$value['id']}") ?>" 
                                        <?= MODAL_LINK ?>
