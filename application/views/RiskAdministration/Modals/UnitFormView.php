...
<div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel"> <?= $environment['draft'] == 0 ? "Edit" : "New Environmrnt"?></h4>
        </div>
        <div class="modal-body">
            ...
            <div class='form-group row'>
                ...
                <div class='col-sm-10'>
                    <select  class='form-control' required=""  name='unit_owner' id='txt-environment-unit_owner'>
